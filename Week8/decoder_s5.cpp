...
char extractChar (int number)
   {
	// if 5 # long int take first two numbers and make into appropriate char
	// if 6 # long int take first three numbers and make into appropriate char	
 	return 0; // temp stub
	}
void insertToFile (char decoded)
	{
	// take file and << into file
	}
